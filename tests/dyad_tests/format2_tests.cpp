...
TEST_CASE("format2 list", "[dyad]")
{
  ...
  // REQUIRE(evalExpression({ints{}, format2, 0}) == ":undefined"s);

  REQUIRE(evalExpression({ints{0}, format2, 0}) == CppValues{"0"s});
  REQUIRE(evalExpression({ints{0}, format2, 1}) == CppValues{"0"s});
  REQUIRE(evalExpression({ints{0}, format2, -1}) == CppValues{"0"s});
  REQUIRE(evalExpression({ints{0}, format2, 2}) == CppValues{"0 "s});
  REQUIRE(evalExpression({ints{0}, format2, -2}) == CppValues{" 0"s});
  REQUIRE(evalExpression({ints{0}, format2, 3}) == CppValues{"0  "s});
  REQUIRE(evalExpression({ints{0}, format2, -3}) == CppValues{"  0"s});

  REQUIRE(evalExpression({ints{0}, format2, 0.0f}) == CppValues{"0"s});
  REQUIRE(evalExpression({ints{0}, format2, 1.0f}) == CppValues{"0"s});
  REQUIRE(evalExpression({ints{0}, format2, -1.0f}) == CppValues{"0"s});
  REQUIRE(evalExpression({ints{0}, format2, 2.0f}) == CppValues{"0 "s});
  REQUIRE(evalExpression({ints{0}, format2, -2.0f}) == CppValues{" 0"s});
  REQUIRE(evalExpression({ints{0}, format2, 3.0f}) == CppValues{"0  "s});
  REQUIRE(evalExpression({ints{0}, format2, -3.0f}) == CppValues{"  0"s});

  REQUIRE(evalExpression({ints{0}, format2, 0.5f}) == CppValues{"0"s});
  REQUIRE(evalExpression({ints{0}, format2, 1.5f}) == CppValues{"0"s});
  REQUIRE(evalExpression({ints{0}, format2, -1.5f}) == CppValues{"0"s});
  REQUIRE(evalExpression({ints{0}, format2, 2.5f}) == CppValues{"0 "s});
  REQUIRE(evalExpression({ints{0}, format2, -2.5f}) == CppValues{" 0"s});
  REQUIRE(evalExpression({ints{0}, format2, 3.5f}) == CppValues{"0  "s});
  REQUIRE(evalExpression({ints{0}, format2, -3.5f}) == CppValues{"  0"s});

  REQUIRE(evalExpression({floats{0.0f}, format2, 0}) == CppValues{"0.0"s});
  REQUIRE(evalExpression({floats{0.0f}, format2, 1}) == CppValues{"0.0"s});
  REQUIRE(evalExpression({floats{0.0f}, format2, -1}) == CppValues{"0.0"s});
  REQUIRE(evalExpression({floats{0.0f}, format2, 2}) == CppValues{"0.0"s});
  REQUIRE(evalExpression({floats{0.0f}, format2, -2}) == CppValues{"0.0"s});
  REQUIRE(evalExpression({floats{0.0f}, format2, 3}) == CppValues{"0.0"s});
  REQUIRE(evalExpression({floats{0.0f}, format2, -3}) == CppValues{"0.0"s});
  REQUIRE(evalExpression({floats{0.0f}, format2, 4}) == CppValues{"0.0 "s});
  REQUIRE(evalExpression({floats{0.0f}, format2, -4}) == CppValues{" 0.0"s});
  REQUIRE(evalExpression({floats{0.0f}, format2, 5}) == CppValues{"0.0  "s});
  REQUIRE(evalExpression({floats{0.0f}, format2, -5}) == CppValues{"  0.0"s});

  REQUIRE(evalExpression({floats{0.0f}, format2, 0.0f}) == CppValues{"0.0"s});
  REQUIRE(evalExpression({floats{0.0f}, format2, 1.0f}) == CppValues{"0.0"s});
  REQUIRE(evalExpression({floats{0.0f}, format2, -1.0f}) == CppValues{"0.0"s});
  REQUIRE(evalExpression({floats{0.0f}, format2, 2.0f}) == CppValues{"0.0"s});
  REQUIRE(evalExpression({floats{0.0f}, format2, -2.0f}) == CppValues{"0.0"s});
  REQUIRE(evalExpression({floats{0.0f}, format2, 3.0f}) == CppValues{"0.0"s});
  REQUIRE(evalExpression({floats{0.0f}, format2, -3.0f}) == CppValues{"0.0"s});
  REQUIRE(evalExpression({floats{0.0f}, format2, 4.0f}) == CppValues{"0.0 "s});
  REQUIRE(evalExpression({floats{0.0f}, format2, -4.0f}) == CppValues{" 0.0"s});
  REQUIRE(evalExpression({floats{0.0f}, format2, 5.0f}) == CppValues{"0.0  "s});
  REQUIRE(evalExpression({floats{0.0f}, format2, -5.0f}) == CppValues{"  0.0"s});

  REQUIRE(evalExpression({floats{0.0f}, format2, 0.5f}) == CppValues{"0.00000"s});
  REQUIRE(evalExpression({floats{0.0f}, format2, -0.5f}) == CppValues{"0.00000"s});
  REQUIRE(evalExpression({floats{0.0f}, format2, 1.5f}) == CppValues{"0.00000"s});
  REQUIRE(evalExpression({floats{0.0f}, format2, -1.5f}) == CppValues{"0.00000"s});
  REQUIRE(evalExpression({floats{0.0f}, format2, 2.5f}) == CppValues{" 0.00000"s});
  REQUIRE(evalExpression({floats{0.0f}, format2, -2.5f}) == CppValues{" 0.00000"s});
  REQUIRE(evalExpression({floats{0.0f}, format2, 3.5f}) == CppValues{"  0.00000"s});
  REQUIRE(evalExpression({floats{0.0f}, format2, -3.5f}) == CppValues{"  0.00000"s});
